    ...
    return (
        <nav className="flex-between w-full mb-16 pt-3">
            ...
            <div className="hidden sm:flex">
                {isUserLoggedIn ? (
                    <div className="flex gap-3 md:gap-5">
                        ...
                        <Link href={"/profile"}><Image src="/assets/images/logo.svg" alt="profile" width={37} height={37}/></Link>
                    </div>
                ): (
                    <>
            ...
            <div className="sm:hidden flex relative">
                {isUserLoggedIn ? (
                    <>
                        <Image src="/assets/images/logo.svg" alt="profile" width={37} height={37} onClick={() => {
